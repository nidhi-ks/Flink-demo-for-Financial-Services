...
resource "confluent_kafka_acl" "connectors_source_create_topic_demo1" {
  kafka_cluster {
    id = confluent_kafka_cluster.cc_kafka_cluster.id
  }
  resource_type = "TOPIC"
...
resource "confluent_kafka_acl" "connectors_source_write_topic_demo1" {
  kafka_cluster {
    id = confluent_kafka_cluster.cc_kafka_cluster.id
  }
  resource_type = "TOPIC"
...
resource "confluent_kafka_acl" "connectors_source_read_topic_demo1" {
  kafka_cluster {
    id = confluent_kafka_cluster.cc_kafka_cluster.id
  }
  resource_type = "TOPIC"
...
resource "confluent_api_key" "connector_key" {
  ...
  depends_on = [
    ...
    confluent_kafka_acl.connectors_source_create_topic_demo1,
    confluent_kafka_acl.connectors_source_write_topic_demo1,
    confluent_kafka_acl.connectors_source_read_topic_demo1,
